...
import com.serprolec.inventario.presentacion.mapeadores.IClienteDtoMapper;

import jakarta.validation.Valid;

@RestController
@RequestMapping("/api/Serprolec/Cliente")
public class ClienteController {
	...
	public ClienteResponseDto guardar(@Valid @RequestBody ClienteRequestDto requestCliente) {
